 ...
 */
@Namespace("/")
@Action(value="precedent")
@Result(name="success", location="currentArticle", type="redirectAction")
public class PrecedentAction extends ActionSupport implements SessionAware{

	private static final long serialVersionUID = 1L;

	// Logger
	private static final Logger log = LogManager.getLogger(PrecedentAction.class);
